...
internal extension Notification.Name {
    internal static let reachabilityChanged = Notification.Name("reachabilityChanged")
}
...
internal class Reachability {
    ...
    required public init(reachabilityRef: SCNetworkReachability, queueQoS: DispatchQoS = .default, targetQueue: DispatchQueue? = nil) {
        ...
        self.reachabilitySerialQueue = DispatchQueue(label: "com.geospark.reachability", qos: queueQoS, target: targetQueue)
    }
