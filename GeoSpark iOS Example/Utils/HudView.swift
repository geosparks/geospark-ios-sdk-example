...
public extension UIView {
    ...
    public func startRotation(duration: CFTimeInterval = 2, repeatCount: Float = Float.infinity, clockwise: Bool = true) {
    ...
    public func cr_fillContainerWithInsets(_ insets: UIEdgeInsets) {
